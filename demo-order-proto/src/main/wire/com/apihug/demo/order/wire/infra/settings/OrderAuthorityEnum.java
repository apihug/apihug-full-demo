...
public enum OrderAuthorityEnum implements Enumeration<OrderAuthorityEnum> {
  ...
  OrderAuthorityEnum(int code, String description, String description2, boolean deprecated) {
    this.code = code;
  ...
  OrderAuthorityEnum(int code, String description, String description2) {
