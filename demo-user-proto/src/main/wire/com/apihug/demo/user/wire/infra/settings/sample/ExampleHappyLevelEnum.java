...
@ProtoFrom(
    ...
    entity = "ExampleHappyLevelEnum",
    kind = Kind.ENUM
)
public enum ExampleHappyLevelEnum implements Enumeration<ExampleHappyLevelEnum> {
  NA(-1, "Default Placeholder Should NEVER be used", "默认占位枚举请勿使用"),

  SAD(0, "very sad", "sad is bad"),

  HAPPY(1, "very happy", "happy is good"),

  SUPER_HAPPY(2, "happiest", "happy best");

  public static final List<String> VALUES;

  public static final List<ExampleHappyLevelEnum> ENUMS;

  public static final List<Integer> CODES;

  public static final Map<String, ExampleHappyLevelEnum> NAME_2_ENUM_MAP;

  public static final Map<Integer, ExampleHappyLevelEnum> CODE_2_ENUM_MAP;

  public static final Enumeration.EnumerationsHelper<ExampleHappyLevelEnum> HELPER;

  static {
    List<String> _VALUES = new ArrayList<>();
    List<ExampleHappyLevelEnum> _ENUMS = new ArrayList<>();
    List<Integer> _CODES = new ArrayList<>();
    Map<String, ExampleHappyLevelEnum> _NAME_2_ENUM_MAP = new LinkedHashMap<>();
    Map<Integer, ExampleHappyLevelEnum> _CODE_2_ENUM_MAP = new LinkedHashMap<>();
    for (ExampleHappyLevelEnum each : ExampleHappyLevelEnum.values()) {
    ...
    HELPER =
    new EnumerationsHelper<ExampleHappyLevelEnum>() {

    @Override
    public ExampleHappyLevelEnum mapFromCode(int code) {
    	return CODE_2_ENUM_MAP.getOrDefault(code, NA);
    }

    @Override
    public ExampleHappyLevelEnum mapFromName(String name) {
    ...
    @Override
    public Class<ExampleHappyLevelEnum> supportClz() {
    	return ExampleHappyLevelEnum.class;
    }
    ...
    @Override
    public List<ExampleHappyLevelEnum> supportEnumerations() {
    return ENUMS;
    }
