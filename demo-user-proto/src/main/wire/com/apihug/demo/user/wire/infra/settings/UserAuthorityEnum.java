package com.apihug.demo.user.wire.infra.settings;
...
@ProtoFrom(
    value = "com/apihug/demo/user/proto/infra/settings/authority.proto",
    pluginVersion = "0.6.0-RELEASE",
    entity = "UserAuthorityEnum",
    kind = Kind.ENUM
)
public enum UserAuthorityEnum implements Enumeration<UserAuthorityEnum> {
  NA(-1, "Default Placeholder Should NEVER be used", "默认占位枚举请勿使用"),

  USER_ADD(1, "user:add", "Authority to remove user"),

  USER_DELETE(2, "user:remove", "Authority to delete user");

  public static final List<String> VALUES;

  public static final List<UserAuthorityEnum> ENUMS;

  public static final List<Integer> CODES;

  public static final Map<String, UserAuthorityEnum> NAME_2_ENUM_MAP;

  public static final Map<Integer, UserAuthorityEnum> CODE_2_ENUM_MAP;

  public static final Enumeration.EnumerationsHelper<UserAuthorityEnum> HELPER;

  static {
    List<String> _VALUES = new ArrayList<>();
    List<UserAuthorityEnum> _ENUMS = new ArrayList<>();
    List<Integer> _CODES = new ArrayList<>();
    Map<String, UserAuthorityEnum> _NAME_2_ENUM_MAP = new LinkedHashMap<>();
    Map<Integer, UserAuthorityEnum> _CODE_2_ENUM_MAP = new LinkedHashMap<>();
    for (UserAuthorityEnum each : UserAuthorityEnum.values()) {
    ...
    HELPER =
    new EnumerationsHelper<UserAuthorityEnum>() {

    @Override
    public UserAuthorityEnum mapFromCode(int code) {
    	return CODE_2_ENUM_MAP.getOrDefault(code, NA);
    }

    @Override
    public UserAuthorityEnum mapFromName(String name) {
    ...
    @Override
    public Class<UserAuthorityEnum> supportClz() {
    	return UserAuthorityEnum.class;
    }
    ...
    @Override
    public List<UserAuthorityEnum> supportEnumerations() {
    return ENUMS;
    }
