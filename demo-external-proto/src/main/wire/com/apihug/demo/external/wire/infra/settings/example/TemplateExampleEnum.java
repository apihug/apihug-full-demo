...
public enum TemplateExampleEnum implements Enumeration<TemplateExampleEnum> {
  ...
  TemplateExampleEnum(int code, String description, String descriptionZhCN, boolean deprecated) {
    this.code = code;
  ...
  TemplateExampleEnum(int code, String description, String descriptionZhCN) {
